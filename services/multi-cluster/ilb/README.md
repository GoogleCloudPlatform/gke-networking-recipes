...
NOTE: Follow only steps 1-4 in the above link to create the cluster and set the context in kubectl client. Its not necessary to set up hub, MCS etc for communication
